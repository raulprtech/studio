...
export function PostEditor() {
    ...
    useEffect(() => {
        if (state.success && state.redirectUrl) {
            toast({
                title: "Éxito",
                description: state.message || "Post creado.",
            });
                    ...
                    <Card>
                        <CardContent className="p-0">
                            <div className="grid gap-2 p-4">
                                ...
                                <Input id="title" name="title" placeholder="Título del Post" className="text-2xl font-bold h-14 border-none shadow-none focus-visible:ring-0 px-0" />
                            </div>
                ...
                <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-4">
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <input type="hidden" name="collectionId" value="posts" />
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="category" name="category" placeholder="Ej. Desarrollo Web" />
                            </div>
                             <div className="grid gap-2">
                             ...
                             <div className="grid gap-2">
                                ...
                                <Input id="authorId" name="authorId" placeholder="Introduce el ID de usuario del autor" />
                            </div>
                        </CardContent>
                        <CardFooter>
                            <SubmitButton />
